...
Do not open a public issue containing sensitive Claude Code or Codex session data,
private project paths, screenshots, secrets, or handoff contents.

## Sensitive Data Guidance

This project works near local Claude Code and Codex session files. Treat those
files as private application state.

Do not commit:

- real `~/.claude/projects` or `~/.codex/sessions` JSONL files
- generated handoff files or `.reference/` folders from private projects
