...
<img src="assets/agent-thread-tools-header.png" alt="Tangled threads from several coding agents pass through a gauge, a filing cabinet, a bridge, and a crane, and wind onto one spool" width="100%">
